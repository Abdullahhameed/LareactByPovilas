...
class PostsCreate extends Component {
    ...
    //         console.log('ff'+this.state.categories);
    // }
        ...
        return (
            ...
            <form onSubmit={this.handleSubmit} >
                ...
                <div className="mt-4">
                    ...
                    <select id="category" value={this.state.category_id} onChange={this.handleCategoryChange} className="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
