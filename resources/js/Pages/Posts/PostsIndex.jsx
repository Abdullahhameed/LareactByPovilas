...
class PostsIndex extends Component {
    ...
    renderCategoryFilter() {
        ...
        return (
            <div className='m-2'>
                <select onClick={this.handleCategoryFilter} className="mt-1 w-full sm:mt-0 rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
        ...
        return (
            <tr className='bg-gray-50'>
                <th>
                    ...
                    {/* <div className='m-2'>
                        <input type="text" value={this.state.query['title']} className='block w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50' />
                    </div> */}
                </th>
                <th>
